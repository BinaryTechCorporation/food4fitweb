<script>
	...
	$(function() {
		...
		imagem = $('img#filePreview').imgAreaSelect({
			fadeSpeed : 400,
			handles : true,
			instance : true
		});
...
<div class="coluna-12">
	<div class="linha" id="nome_pagina">Sobre a Empresa</div>
	<form id="formSobreEmpresa" name='formSobreEmpresa'
		...
		<div class="linha">
			...
			<div class="coluna-08">
				<div class="linha">
					...
					<input type="text" name="titulo" required class="inputs_formulario"
						maxlength="50">
				</div>
				<div class="linha">
					<label for="descricao" class="label_formulario"> Descrição:
					</label> <br>
